...
*	https://techmaker.ua
*
*	STM32 driver for NXP Mifare RC522 RFID chip with HAL library
*	based on library by Tilen Majerle
*	02 May 2017 by Alexander Olenyev <sasha@techmaker.ua>
*/
...
#if defined(CS_Pin)
/* SPI chip enable pin */
#define MFRC522_CS_PIN							CS_Pin
#define MFRC522_CS_GPIO_PORT					CS_GPIO_Port
/* Pins configuration */
#define MFRC522_CS_LOW()		HAL_GPIO_WritePin(MFRC522_CS_GPIO_PORT, MFRC522_CS_PIN, GPIO_PIN_RESET)
#define MFRC522_CS_HIGH()		HAL_GPIO_WritePin(MFRC522_CS_GPIO_PORT, MFRC522_CS_PIN, GPIO_PIN_SET)
#else
#error You have to label pin CS in CubeMX!
#endif
